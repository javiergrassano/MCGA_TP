...
namespace MCGA_WS
{
    ...
    public class TP2 : System.Web.Services.WebService
    {
        ...
        {
            string errores = "";
            if (L < 0) errores += "El valor de L es incorrecto tiene que ser mayor a 0\n";
            if (td < 0) errores += "El valor de L es incorrecto tiene que ser mayor a 0\n";
            if (Ck < 0 || Ck > 11000) errores += "El valor de Ck es incorrecto tiene que estar entre 0 y 11000";
